...
&nbsp;&nbsp;
    <asp:Label ID="Label13" runat="server" style="font-size: smaller" 
        Text="Faculty Photo"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox ID="txtPhoto" runat="server" 
        style="top: 89px; left: 20px; position: absolute; height: 18px; width: 128px"></asp:TextBox>
    <asp:Image ID="PhotoBox" runat="server" ImageAlign="Left" 
        
        style="top: 125px; left: 12px; position: absolute; width: 153px; height: 177px;" />
...
&nbsp;
    ...
    <asp:TextBox ID="txtID" runat="server" 
        ...
        Width="140px" ontextchanged="txtID_TextChanged"></asp:TextBox>
    <p style="line-height: 1px">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
