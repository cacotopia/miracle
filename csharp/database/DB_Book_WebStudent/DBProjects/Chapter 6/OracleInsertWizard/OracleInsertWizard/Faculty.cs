    ...
    public partial class FacultyForm : Form
    {
        ...
        private void cmdSelect_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.fACULTYTableAdapter1.FillByFacultyName(cSE_DEPTDataSet1.FACULTY, ComboName.Text);
                    if (cSE_DEPTDataSet1.FACULTY.Count == 0)
        ...
        {
            this.fACULTYTableAdapter1.Fill(cSE_DEPTDataSet1.FACULTY);
            var facultyinfo = (from fi in cSE_DEPTDataSet1.FACULTY
