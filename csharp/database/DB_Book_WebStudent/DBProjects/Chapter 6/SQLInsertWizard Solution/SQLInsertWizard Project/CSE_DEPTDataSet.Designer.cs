...
namespace SQLInsertWizard.CSE_DEPTDataSetTableAdapters {
...
SELECT course_id, course, credit, classroom, schedule, enrollment, faculty_id FROM Course WHERE (course_id = @course_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQLInsertWizard.Properties.Settings.Default.CSE_DEPTConnectionSQL;
        }
...
SELECT faculty_id, faculty_name, office, phone, college, title, email FROM Faculty WHERE (faculty_id = @faculty_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param1", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "faculty_name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
