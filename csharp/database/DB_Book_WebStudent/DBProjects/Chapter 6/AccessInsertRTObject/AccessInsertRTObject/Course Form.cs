...
namespace AccessInsertRTObject
{
    public partial class CourseForm : Form
    {
        ...
        private void cmdSelect_Click(object sender, EventArgs e)
        {
            ...
            strCourse += "ON (Course.faculty_id = Faculty.faculty_id) AND (Faculty.faculty_name = @name)";
            ...
            accCmdCourse.Parameters.Add("@name", OleDbType.Char).Value = ComboName.Text;
        ...
        {  
            ...
            accCommand.Parameters.Add("@courseid", OleDbType.Char).Value = CourseList.SelectedItem;
