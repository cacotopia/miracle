...
namespace MSSQLSelectRTObjectLINQ
{
    ...
    partial void DeleteStudentCourse(StudentCourse instance);
		...
		public CSE_DEPTDataContext() : 
				base(global::MSSQLSelectRTObjectLINQ.Properties.Settings.Default.CSE_DEPTConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		[Function(Name="dbo.StudentInfo")]
		public ISingleResult<StudentInfoResult> StudentInfo([Parameter(Name="StudentName", DbType="VarChar(50)")] string studentName)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), studentName);
			return ((ISingleResult<StudentInfoResult>)(result.ReturnValue));
		}
		
		[Function(Name="dbo.StudentCourseInfo")]
		public ISingleResult<StudentCourseInfoResult> StudentCourseInfo([Parameter(Name="StudentID", DbType="VarChar(50)")] string studentID)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), studentID);
			return ((ISingleResult<StudentCourseInfoResult>)(result.ReturnValue));
		}
	}
    ...
    partial void OnemailChanged();
        ...
        [Column(Storage = "_faculty_name", DbType = "NVarChar(50)", UpdateCheck = UpdateCheck.Never)]
	...
	public partial class StudentInfoResult
	{
	...
	public partial class StudentCourseInfoResult
	{
		
		private string _course_id;
		
		public StudentCourseInfoResult()
		{
		}
