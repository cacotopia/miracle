    ...
    public partial class CourseForm : Form
    {
        ...
        private void LINQtoDataSet(string facultyID)
        {
            ...
            foreach (var cRow in courseinfo)
            {
                ...
                this.txtSchedule.Text = cRow.Field<string>("schedule");
                this.txtClassRoom.Text = cRow.Field<string>("classroom");
                this.txtCredits.Text = cRow.Field<string>("credit");
                this.txtEnroll.Text = cRow.Field<string>("enrollment");
            }  
        }        
    }
}
