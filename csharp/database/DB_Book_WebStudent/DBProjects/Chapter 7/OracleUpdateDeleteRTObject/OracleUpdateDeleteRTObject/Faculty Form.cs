...
namespace OracleUpdateDeleteWizard
{
    public partial class FacultyForm : Form
    {
        ...
        private void UpdateParameters(ref OracleCommand cmd)
        {
            ...
            cmd.Parameters.Add("Param1", OracleType.Char).Value = ComboName.Text;
        }

        private void cmdDelete_Click(object sender, EventArgs e)
        {
            string cmdString = "DELETE FROM Faculty WHERE (faculty_name =: Param1)";
            ...
            if (Answer == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                oraCommand.CommandType = CommandType.Text;
                oraCommand.CommandText = cmdString;
                oraCommand.Parameters.Add("Param1", OracleType.Char).Value = ComboName.Text;
