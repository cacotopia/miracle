...
&nbsp;<asp:Image ID="PhotoBox" runat="server" ImageAlign="Left" 
        ...
        style="top: 115px; left: 13px; position: absolute; width: 149px; height: 173px;" />
    <asp:Label ID="Label12" runat="server" Font-Size="Smaller" 
        style="font-size: small" Text="Method"></asp:Label>
    &nbsp;&nbsp;<asp:DropDownList ID="ComboMethod" runat="server" 
        style="top: 83px; left: 17px; position: absolute; height: 22px; width: 143px">
    </asp:DropDownList>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
